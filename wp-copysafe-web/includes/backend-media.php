...
class WPCSW_Backend_Media {

	public function uploader()
	{
		//Check for nonce validation
		$wpcsw_media_upload_nonce = isset($_GET['wpcsw_token']) ? sanitize_key(wp_unslash($_GET['wpcsw_token'])) : '';
		...
		?>
<div id="wpcsw_div" title="SecureImage">
    <div id="wpcsw_message"></div>
    <div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
        <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
            <?php if ($allow_uploads) { ?>
            <li class="ui-state-default ui-corner-top ui-state-active"><a class="ui-tabs-anchor" id="wpcsw-tabs-1-bt">Add New</a></li>
            <?php } ?>
            <li class="ui-state-default ui-corner-top <?php echo ($allow_uploads) ? "" : "ui-state-active"; ?>"><a class="ui-tabs-anchor" id="wpcsw-tabs-2-bt">Search</a></li>
            <li class="ui-state-default ui-corner-top"><a class="ui-tabs-anchor" id="wpcsw-tabs-3-bt">Existing Files</a></li>
        </ul>
          ...
          <div id="wpcsw-tabs-1"
              ...
              <div class="wpcsw_upload_content">
                    ...
                    <table>
                        <tr>
                            <td>
                                <div class="wpcsw-mfu-plugin-uploader multiple">
                                    <input id="wpcsw-plugin-uploader-button" type="button" value="<?php esc_attr_e('Select Files', 'wp-copysafe-web'); ?>" class="wpcsw-plugin-uploader-button button">
                                    <span class="ajaxnonce" id="<?php echo esc_attr(wp_create_nonce('wpcsw_upload_nonce')); ?>"></span>
                                </div>
                            </td>
                        <tr>
                            <td>
              ...
              <input type="hidden" value="<?php echo esc_attr($max_upload_size); ?>" id="wpcsw-upload-max-size"/>
        ...
        <div id="wpcsw-tabs-2"
            ...
            <p class="search-control">
                <span>File name :</span> <input type="text" id="wpcsw_searchfile" name="wpcsw_searchfile" class="regular-text"/>
                <input type="hidden" value="<?php echo esc_attr($post_id); ?>" name="postid" id="postid"/>
                <input type="button" value="Search" class="button button-primary" id="wpcsw-search" name="search"/>
        ...
        <div id="wpcsw-tabs-3"
            ...
            <table class="wp-list-table widefat">
                ...
                <?php echo wp_kses(wpcsw_get_uploadfile_list(), wpcsw_instance()->settings->kses_allowed_options()); ?>
                </tbody>
                <tfoot>
                <tr>
                    <th>&nbsp;</th>
